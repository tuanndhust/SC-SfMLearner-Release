...
parser.add_argument("--output-dir", type=str, default='./out_ros/',help="Output directory for saving predictions in a big 3D numpy file")
...
class PoseEstimator:
    ...
    def __init__(self, args):
        ...
        self.pose_pub = rospy.Publisher("OdomOut",PoseStamped)
    ...
    def callback(self,data):
        try:
            ...
            if len(self.tensor_imgs) == 2:
                ...
                #  pose_mat: T a to b (T t to t+1)
                self.global_pose = self.global_pose @  np.linalg.inv(pose_mat)

                pose_msg = Tmat2PoseMsg(self.global_pose)
